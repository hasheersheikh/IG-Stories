...
export default function IgStories() {
  ...
  const initialUserIndex = route.params?.userIndex || 0;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.storyContainer}>
        <Image source={story.uri} style={styles.image} />
...
const styles = StyleSheet.create({
  ...
  footer: { width: "100%", backgroundColor: "black", padding: 10 },
  input: {
    borderWidth: 1,
    borderColor: "gray",
    padding: 15,
  ...
  navPressable: { position: "absolute", width: "30%", height: "100%" },
  indicatorRow: { gap: 5, flexDirection: "row", marginBottom: 20 },
  indicatorBG: {
    flex: 1,
    height: 3,
  ...
  indicator: { backgroundColor: "white", height: "100%" },
});
